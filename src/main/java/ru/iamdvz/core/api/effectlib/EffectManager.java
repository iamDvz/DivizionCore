...
import ru.iamdvz.core.api.effectlib.math.Transforms;
import ru.iamdvz.core.api.effectlib.util.ConfigUtils;
import ru.iamdvz.core.api.effectlib.util.CustomSound;
import ru.iamdvz.core.api.effectlib.util.Disposable;
import ru.iamdvz.core.api.effectlib.util.DynamicLocation;
import ru.iamdvz.core.api.effectlib.util.ImageLoadCallback;
import ru.iamdvz.core.api.effectlib.util.ImageLoadTask;
import ru.iamdvz.core.api.effectlib.util.ParticleDisplay;
...
public class EffectManager implements Disposable {
     ...
     *
     * @param effectClass The name of the Effect class to instantiate. If unqualified, defaults to the ru.iamdvz.core.api.effectlib.effect namespace.
    ...
    public Effect getEffectByClassName(String effectClass) {
        ...
        try {
            ...
            if (effectLibClass == null && !effectClass.contains(".")) {
                effectClass = "ru.iamdvz.core.api.effectlib.effect." + effectClass;
